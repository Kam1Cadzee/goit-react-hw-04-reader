(window.webpackJsonp = window.webpackJsonp || []).push([
  [0],
  {
    13: function(e, i, t) {
      e.exports = {
        button: 'Controls_button__Tc1Oi',
        controls: 'Controls_controls__fu_dr',
      };
    },
    15: function(e, i, t) {
      e.exports = {
        backdrop: 'Modal_backdrop__1THXf',
        modal: 'Modal_modal__1YLvN',
      };
    },
    16: function(e, i, t) {
      e.exports = {
        title: 'ErrorRangePage_title__3sonQ',
        btn: 'ErrorRangePage_btn__3bl_b',
      };
    },
    24: function(e, i, t) {
      e.exports = { publication: 'Publication_publication__3uHQL' };
    },
    25: function(e, i, t) {
      e.exports = { counter: 'Counter_counter__BiphN' };
    },
    26: function(e, i, t) {
      e.exports = { reader: 'Reader_reader__2wJCz' };
    },
    29: function(e) {
      e.exports = [
        {
    ...
    55: function(e, i, t) {
      ...
      var E = h,
        ...
        A = function(e) {
          var i = e.index,
            t = e.length,
            u = ''.concat(i + 1, '/').concat(t + 1);
          return a.a.createElement('p', { className: g.a.counter }, u);
        },
        N = t(13),
        D = t.n(N),
        Q = function(e) {
        ...
        P = (function(e) {
          function i() {
            var e, t;
            Object(m.a)(this, i);
            for (var u = arguments.length, s = new Array(u), o = 0; o < u; o++)
              s[o] = arguments[o];
            return (
              ((t = Object(d.a)(
                this,
                (e = Object(c.a)(i)).call.apply(e, [this].concat(s)),
              )).refBackdrop = a.a.createRef()),
              (t.handleKeyPress = function(e) {
                'Escape' === e.code && (0, t.props.onClose)();
              }),
              (t.handleBackdropClick = function(e) {
                var i = t.refBackdrop.current;
                (i && e.target !== i) || (0, t.props.onClose)();
              }),
              t
            );
          }
              ...
              },
              {
                ...
                value: function() {
                  ...
                  return a.a.createElement(
                    'div',
                    {
                      className: _.a.backdrop,
                      ref: this.refBackdrop,
                      onClick: this.handleBackdropClick,
                      'aria-hidden': 'true',
                    },
                    a.a.createElement('div', { className: _.a.modal }, e),
                  );
                },
              },
            ]),
        ...
        k = function() {
          return a.a.createElement(
            ...
            a.a.createElement(
              n.b,
              { className: V.a.btn, to: '/reader' },
              '\u0412\u0435\u0440\u043d\u0443\u0442\u044c\u0441\u044f',
            ),
          );
        },
        w = function(e) {
          return v.a.parse(e.location.search).item;
        },
        O = (function(e) {
          function i() {
            var e, t;
            ...
            return (
              ((t = Object(d.a)(
                this,
                (e = Object(c.a)(i)).call.apply(e, [this].concat(a)),
              )).state = { showModal: !1 }),
              (t.handelToggleModal = function() {
                t.setState(function(e) {
                  return { showModal: !e.showModal };
                });
              }),
              (t.prevPublic = function() {
                var e = t.props,
                  i = e.location,
                  u = e.history,
                  a = +w(t.props);
                u.push({ pathname: i.pathname, search: 'item='.concat(a - 1) });
              }),
              (t.nextPublic = function() {
                var e = t.props,
                  i = e.location,
                  u = e.history,
                  a = +w(t.props);
            ...
            Object(l.a)(i, [
              {
                ...
                value: function() {
                  ...
                  return t >= e.length || t < 0
                    ...
                    : a.a.createElement(
                        'div',
                        { className: I.a.reader },
                        a.a.createElement(E, {
                          item: e[t],
                          onOpen: this.handelToggleModal,
                        }),
                        a.a.createElement(A, { index: t, length: u }),
                        a.a.createElement(Q, {
                        ...
                        i &&
                          a.a.createElement(
                            ...
                            a.a.createElement(E, { item: e[t], isShowAll: !0 }),
                          ),
                      );
                },
              },
        ...
        R = function(e) {
          var i = e.location,
            t = e.history;
          return '' === i.search
            ? (t.replace({ pathname: i.pathname, search: 'item=1' }), null)
            : a.a.createElement(
                'div',
                null,
                a.a.createElement(y, { items: U }),
              );
        };
      o.a.render(
        a.a.createElement(
          ...
          a.a.createElement(
            ...
            a.a.createElement(r.a, { to: '/reader' }),
          ),
        ),
...
//# sourceMappingURL=main.1dcdd2d6.chunk.js.map
